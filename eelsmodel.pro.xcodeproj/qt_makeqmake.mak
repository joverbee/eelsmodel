...
QMAKE    = /usr/bin/qmake
eelsmodel.pro.xcodeproj/project.pbxproj: eelsmodel.pro  /usr/local/Qt4.8/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.8/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o eelsmodel.pro.xcodeproj/project.pbxproj eelsmodel.pro
