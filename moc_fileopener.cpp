...
static const char qt_meta_stringdata_Fileopener[] = {
    "Fileopener\0"
};
...
const QMetaObjectExtraData Fileopener::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Fileopener::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Fileopener,
      qt_meta_data_Fileopener, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Fileopener::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Fileopener))
