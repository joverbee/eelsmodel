...
/**
 * eelsmodel - core/component.h
 *
 * Component is a spectrum which can create its own content by an internal
 * function. Component is used to derive several specific components which
 * have their own way to calculate like e.g. a lorentz peak.
 **/
