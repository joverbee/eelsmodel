...
# Generated by qmake (2.01a) (Qt 4.8.5) on: Wed Oct 23 20:41:30 2013
...
INCPATH       = -I/usr/local/Qt4.8/mkspecs/macx-xcode -I. -I/Library/Frameworks/QtCore.framework/Versions/4/Headers -I/usr/include/QtCore -I/Library/Frameworks/QtGui.framework/Versions/4/Headers -I/usr/include/QtGui -I/usr/include -I/usr/local/atlas-3.10.1/include -I../boost/boost_1_34_1 -I/usr/local/include -I/Developer/usr/include -I../qwt-6.1.0/src -I. -Isrc -Isrc/core -Isrc/gui -Isrc/components -Isrc/fitters -I. -I/usr/local/include -I/System/Library/Frameworks/CarbonCore.framework/Headers -F/Library/Frameworks
DEL_FILE  = rm -f
MOVE      = mv -f
...
compilers: ./moc_eelsmodel.cpp ./moc_image.cpp ./moc_atomchooser.cpp\
	 ...
	 ./moc_realinput.cpp ./moc_saysomething.cpp ./moc_graphqwt.cpp
compiler_objective_c_make_all:
compiler_objective_c_clean:
compiler_moc_header_make_all: moc_eelsmodel.cpp moc_image.cpp moc_atomchooser.cpp moc_componentmaintenance.cpp moc_componentselector.cpp moc_detectorchooser.cpp moc_Drudeoptions.cpp moc_equalizer.cpp moc_fileopener.cpp moc_fitter_dialog.cpp moc_fitterchooser.cpp moc_GDOSoptions.cpp moc_getfilename.cpp moc_getgraphptr.cpp moc_graph.cpp moc_hello.cpp moc_imagedisplay.cpp moc_integerinput.cpp moc_interactive_parameter.cpp moc_menu.cpp moc_monitorchooser.cpp moc_realinput.cpp moc_saysomething.cpp moc_graphqwt.cpp
...
moc_graphqwt.cpp: src/gui/graphqwt.h
	/Developer/Tools/Qt/moc $(DEFINES) $(INCPATH) -D__APPLE__ -D__GNUC__ src/gui/graphqwt.h -o moc_graphqwt.cpp
